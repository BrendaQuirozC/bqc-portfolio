...
export default function Hero() {
  ...
  return (
    <section id="hero" className="container-main min-h-screen flex items-center justify-center relative overflow-hidden bg-cream">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h2 className="text-2xl md:text-3xl font-mono font-medium mb-2">
            ...
            >
              ...
              <span className="text-mocha font-medium">impeccable esthetic</span> with{' '}
            ...
            >
              <div className="glass-dark p-4 rounded-2xl text-center">
                <div className="text-3xl font-display font-bold text-mocha mb-1">7+</div>
                <div className="text-xs text-slate">Years</div>
              </div>
              <div className="glass-dark p-4 rounded-2xl text-center">
                <div className="text-3xl font-display font-bold text-coral mb-1">6+</div>
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              transition={{ delay: 5 }}
              className="socialmedia-icons flex gap-6 mt-10"
            >
              <a 
                href="https://github.com/brendaquirozc" 
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate hover:text-mocha transition-colors duration-300 group flex items-center gap-2"
                aria-label="GitHub"
              >
                <svg className="w-5 h-5 group-hover:scale-110 transition-transform social-icon" fill="#9bb89f" viewBox="0 0 24 24">
                ...
                <span className="social-url hidden">https://github.com/brendaquirozc</span>
              </a>
              <a 
              ...
              >
                ...
                <span className="social-url hidden">https://linkedin.com/in/brendaquirozmac</span>
              </a>
              <a 
                ...
                aria-label="Email"
              >
                <svg className="w-5 h-5 group-hover:scale-110 transition-transform social-icon" fill="none" stroke="#9bb89f" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="social-url hidden">brendaqc.contact@gmail.com</span>
              </a>
            </motion.div>
          </motion.div>
          ...
          <motion.div
            ...
            className="image-container lg:block relative photo-placeholder"
          >
            <div className="relative">
              ...
              <div className="img-content relative glass p-12 rounded-[2.5rem] aspect-square flex items-center justify-center">
                ...
                {!photoError && (
                  <Fragment>
                    ...
                    />
                    <div className="absolute bottom-0 left-0 w-full h-10 flex items-center justify-center footer-img-div">
                    <p className="text-xs footer-img-text">B.Sc. in Applied Mathematics and Computing
                    </p>
                    </div>
                  </Fragment>
                )}
              ...
              >
                <span className="text-xs font-mono text-mocha">React Specialist</span>
              </motion.div>
              <motion.div
                animate={{ y: [0, 10, 0] }}
